...
When no reduction is applied, Table \ref{tab:result_dfg_table} shows that for the BPI12 and 17 logs below 10\% deviation can be achieved, mostly for equisized aggregation. 
