...
\begin{figure}[tb]
	\centering
	\subfigure[Most common DF - equisize]{\includegraphics[width=0.39\textwidth]{./img/sepsis_1.png}}
	\subfigure[Most common DF - equitemp]{\includegraphics[width=0.39\textwidth]{./img/sepsis_1_t.png}}
	\caption{Sepsis}
	\label{fig:sepsists}
\end{figure}
