...
In order to obtain training data, time series are obtained by specifying a number of intervals (i.e. time steps in the DF time series) using either equitemporal or equisized aggregation a described in Section \ref{sec:preliminaries}.
...
The entropic relevance also allows to compare the adequacy of the forecasted DFGs with the actual DFGs.
